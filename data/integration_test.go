...
func TestUser_GetByEmail(t *testing.T) {
	u, err := models.Users.GetByEmail("me@someguy.com")
	if err != nil {
		t.Error("Failed to get user: ", err)
	}
...
func TestUser_ResetPassword(t *testing.T) {
	...
	if err == nil {
		t.Error("Did not get an error when trying to reset password for not-existent user")
	}
}
...
var authData = []struct {
	...
	},
	{
		...
		"a@company.com",
		true,
		"token of wrong length token accepted as valid",
	},
	{
		"no_user",
		"abcdefghijklmnopqrstuvwxyz",
		"a@company.com",
		true,
		"no user, but token accepted as valid",
	},
	{"valid", "", "me@someguy.com", false, "valid token reported as invalid"},
}
